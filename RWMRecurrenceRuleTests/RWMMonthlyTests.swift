...
class RWMMonthlyTests: RWMRecurrenceRuleBase {
    ...
    func testMonthly01e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;COUNT=3", start: start, exclusionDates: exclusionDates, results:
            ["2018-06-17T09:00:00", "2018-06-17T09:00:00", "2018-09-17T09:00:00"]
        )
    }
    ...
    func testMonthly02e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;INTERVAL=3;COUNT=3", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly03e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTH=5,6;COUNT=3", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly04e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=2,4,6;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly05e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=2,-1;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly06e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=2,4,6;INTERVAL=2;COUNT=8", start: start, results:
    ...
    func testMonthly07e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=2,-1;INTERVAL=3;COUNT=10", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly08e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=TU,TH;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly09e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=1MO,-1FR;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly10e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=TU,TH;INTERVAL=3;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly11e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=1MO,-1FR;INTERVAL=2;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly12e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=2,4,6;BYMONTH=3,5;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly13e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTH=6;BYMONTHDAY=2,-1;COUNT=8", start: start, exclusionDates: exclusionDates, results:
            ["2018-06-02T09:00:00", "2019-06-02T09:00:00",
             "2019-06-30T09:00:00", "2020-06-02T09:00:00", "2020-06-30T09:00:00", "2021-06-02T09:00:00",
             "2021-06-30T09:00:00", "2022-06-02T09:00:00"]
        )
    }
    ...
    func testMonthly14e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=TU,TH;BYMONTH=8;COUNT=13", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly14ae() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=TU,2TH;BYMONTH=8;COUNT=13", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly15e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=1MO,-1FR;BYMONTH=3,9;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly16e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYDAY=TU,TH;BYMONTHDAY=10,11,12,13,14;COUNT=10", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly17e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTHDAY=1,2,3,-1,-2,-3;BYDAY=1MO,-1FR;COUNT=8", start: start, exclusionDates: exclusionDates, results:
    ...
    func testMonthly18e() {
        ...
        run(rule: "RRULE:FREQ=MONTHLY;BYMONTH=1,2,3;BYMONTHDAY=1,2,3;BYDAY=SU,MO,TU;COUNT=10", start: start, exclusionDates: exclusionDates, results:
